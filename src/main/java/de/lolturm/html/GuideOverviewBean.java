	...
	public String getGuideOverviewHtml() {
		...
		try {
			...
			for (GuideBean guide : guides) {
				...
				html +=	"<img src='/images/icons/" + guide.getPosition() + ".png' />\n";
				html +=	"</div>\n";
				html +=	"<div class='keystone'>\n";
				html +=	"<img src='/images/runes/" + KeystoneEnum.getById(Integer.parseInt(guide.getRunes().getKeystoneId())).getEnglischText() + ".png' />\n";
				html +=	"</div>\n";
				html +=	"<div class='secondtree'>\n";
				html +=	"	<img src='/images/runes/" + KeystoneEnum.getById(Integer.parseInt(guide.getRunes().getSecondTreeId())).getEnglischText() + ".png' />\n";
				html +=	"</div>\n";
				html +=	"<div class='info'>\n";
				...
				html += "<a href='/GuideServlet?guide=" + guide.getId() + "'>";
