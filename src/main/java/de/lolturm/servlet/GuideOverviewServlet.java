...
public class GuideOverviewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (login.equals("Login")) {
			response.sendRedirect("/LoginServlet?comeFrom=GuideOverviewServlet");
		} else if (comeFrom.equals("LoginServlet")) {
			response.sendRedirect("/jsp/GuideOverview.jsp");
			...
			response.sendRedirect("/IndexServlet?comeFrom=GuideOverviewServlet");
		}
	}
