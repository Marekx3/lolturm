	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!guide.equals("9999999")) {
			try {
				...
				response.sendRedirect("/lolturm/jsp/Guide.jsp");
			} catch (ClassNotFoundException | SQLException e) {
				e.printStackTrace();
				response.sendRedirect("/lolturm/IndexServlet?comeFrom=GuideServlet");
			}
			...
			if(!username.equals("")) {
				...
				response.sendRedirect("/lolturm/LoginServlet?comeFrom=GuideServlet");
			}
			...
			response.sendRedirect("/lolturm/NewGuideServlet?comeFrom=GuideServlet");
